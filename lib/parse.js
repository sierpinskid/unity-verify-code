...
function parse(email, password, port, tls, host, savePath) {
  ...
  console.log('[INFO] host: ' + host ?? getHost(email));
        ...
        f.on('message', function(msg, seqno) {
          ...
          msg.on('body', function(stream, info) {
            stream.on('data', function (chunk) {
              ...
              console.log('[Info] found code part with start: ' + start + ', end: ' + end);
              ...
              console.log('[INFO] Extracted code part: ' + part + ' to path: ' + savePath)
